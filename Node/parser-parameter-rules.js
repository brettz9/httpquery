/* globals $ -- Need to figure out this file */

const PEG = require('pegjs'),
  // Can call toSource() on parser to get source
  parser = PEG.buildParser("start = ('a' / 'b')+");
// Could take second argument of boolean options, "cache" and "trackLineAndColumn"
parse.parse(str);
...
*/
const rfc2616ParameterRules = new Parser(
  {
    /*
...
const rfc5987ParameterRules = new Parser(
