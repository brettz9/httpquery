...
const debug = 1,
  ...
  clientSupportCheck = function (req, str) {
    return req.headers['query-client-support'] &&
            req.headers['query-client-support'].trim().split(/\s+/).includes(str);
  };
...
http.createServer(function (req, res) {
  ...
  fs.readFile(url, function (err, fileContents) {
    ...
    let doc, xpath1Request, queryResult, $, css3RequestFull, css3Request, type, css3Attr,
